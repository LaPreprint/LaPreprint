...
\metadata[]{Funding}{MRA was supported by funding from the Leverhulme Foundation.}
...
\begin{document}
\maketitle
\input{src/chapters/abstract.tex}
\input{src/chapters/prelude.tex}
\input{src/chapters/introduction.tex}
\input{src/chapters/methods.tex}
\input{src/chapters/results.tex}
\input{src/chapters/discussion.tex}
\input{src/chapters/formal.tex}
\printbibliography
